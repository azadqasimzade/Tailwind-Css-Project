  ...
  return (
    <>
      <div className='bg-brandColor'>
        <div className='md:container mx-auto lg:px-28 h-16 md:h-11 flex items-center justify-center md:justify-between'>
          <a href="/">
      ...
      <div className='md:container mx-auto lg:px-28 flex md:hidden items-center justify-between h-10 px-2'>
          <a href='/' className='flex items-center gap-x-2 text-sm font-semibold text-gray-700'>
            <HiLocationMarker size={18} className="text-primaryBrandColor"/>
            Teslimat adresi belirle
          </a>
          <button>
            <IoIosArrowForward size={18} className='text-primaryBrandColor'/>
          </button>
      </div>
    </>
  )
